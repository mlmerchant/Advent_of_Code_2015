...
# Filter for 'children: 3' or lines without 'children'
cat challenge.txt | grep 'children: 3' > 1.txt
cat challenge.txt | grep -v 'children' >> 1.txt

# Filter for 'cats: 7' or lines without 'cats'
cat 1.txt | grep 'cats: 7' > 2.txt
cat 1.txt | grep -v 'cats' >> 2.txt

# Filter for 'samoyeds: 2' or lines without 'samoyeds'
cat 2.txt | grep 'samoyeds: 2' > 3.txt
cat 2.txt | grep -v 'samoyeds' >> 3.txt

# Filter for 'pomeranians: 3' or lines without 'pomeranians'
cat 3.txt | grep 'pomeranians: 3' > 4.txt
cat 3.txt | grep -v 'pomeranians' >> 4.txt

# Filter for 'akitas: 0' or lines without 'akitas'
cat 4.txt | grep 'akitas: 0' > 5.txt
cat 4.txt | grep -v 'akitas' >> 5.txt

# Filter for 'vizslas: 0' or lines without 'vizslas'
cat 5.txt | grep 'vizslas: 0' > 6.txt
cat 5.txt | grep -v 'vizslas' >> 6.txt

# Filter for 'goldfish: 5' or lines without 'goldfish'
cat 6.txt | grep 'goldfish: 5' > 7.txt
cat 6.txt | grep -v 'goldfish' >> 7.txt

# Filter for 'trees: 3' or lines without 'trees'
cat 7.txt | grep 'trees: 3' > 8.txt
cat 7.txt | grep -v 'trees' >> 8.txt

# Filter for 'perfumes: 1' or lines without 'perfumes'
